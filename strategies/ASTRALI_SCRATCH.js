...
//	console.log('trix going down .. no thanks');
};
//------------------------------------------------------------------
...
//------------------------------------------------------------------
if (cciResult > sellCciOver) {
//	console.log('trix high enough (more than +100)');
	timeToSell +=1;
}
else {
//	console.log('trix low - no selling time');
};
//------------------------------------------------------------------
if (trixResult < trixResultPrev) {
...
//	console.log('trix going up .. no selling now');
};
